...
public class ShopperInfoHttpService : HttpService, IShopperInfoHttpService
{
    private readonly AddressService _addressService;

    public ShopperInfoHttpService(HttpClient httpClient, AddressService addressService)
        : base(httpClient)
    {
