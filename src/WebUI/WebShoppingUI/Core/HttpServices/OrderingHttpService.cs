...
public class OrderingHttpService : HttpService, IOrderingHttpService
{
    private readonly AddressService _addressService;

    public OrderingHttpService(HttpClient httpClient, AddressService addressService) : base(httpClient)
    {
