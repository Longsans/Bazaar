...
{
    public bool IsSuccess => ErrorType is null && ErrorDetail is null;
    ...
    public static ServiceCallResult NotFound(string? detail = null)
    ...
    where T : class
{
    ...
    public static new ServiceCallResult<T> NotFound(string? detail = null)
        => new(ServiceCallError.NotFound, detail);
